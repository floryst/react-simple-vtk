...
class VtkMpr extends React.Component {
    constructor(props) {
      super(props);
    ...
    componentDidMount() {
	  ...
	  this.labelPipeline.mapper.setInputConnection(this.paintFilter.getOutputPort());
    ...
    componentDidUpdate(prevProps) {
      if (prevProps.data !== this.props.data) {
        if (this.props.data && !this.props.data.isA('vtkImageData')) {
          ...
          if (!prevProps.data && this.props.data) {
            ...
            this.subs.data.sub(this.props.data.onModified(() =>
      ...
      if (prevProps.labelmap !== this.props.labelmap && this.props.labelmap) {
		...
		// You can update the labelmap externally just by calling modified()
      	...
      	this.subs.labelmap.sub(this.props.labelmap.modified(() => {
      		this.renderWindow.render();
      	}));
      }
      ...
      if (prevProps.painting !== this.props.painting) {
	      ...
	      this.subs.paintStart.sub(this.viewWidget.onStartInteractionEvent(() => {
	      ...
	      this.subs.paint.sub(this.viewWidget.onInteractionEvent(() => {
	      ...
	      this.subs.paintEnd.sub(this.viewWidget.onEndInteractionEvent(() => {
...
function go(p) {
	ReactDOM.render(
		<VtkMpr
			...
			painting={p}
			onPaintStart={() => console.log('paint start')}
			onPaint={() => console.log('paint')}
			onPaintEnd={() => console.log('paint end')}
		/>,
